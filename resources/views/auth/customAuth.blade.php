...
<html lang="en">
	...
	<head>
		...
		<link href="{{ asset('assets/css/css/pages/login/classic/login-3.css')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
					...
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							...
							<form class="form" id="kt_login_signin_form">
								...
								<div class="form-group">
									<input id ="sInEmail" class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" type="text" placeholder="Email" name="username" autocomplete="off" />
								</div>
								<div class="form-group">
									<input id="sInPwd" class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" type="password" placeholder="Password" name="password" />
								</div>
						...
						<div class="login-signup">
							...
							<form class="form text-center" id="kt_login_signup_form">
								@csrf
								<div class="form-group">
									<input id="regFullName" class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="text" placeholder="Fullname" name="fullname" />
								</div>
								<div class="form-group">
									<input id="regEmail" class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="text" placeholder="Email" name="email" autocomplete="off" />
								</div>
								<div class="form-group">
									<input id="regPwd" class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="password" placeholder="Password" name="password" />
								</div>
								<div class="form-group">
									<input id="refPwdCofirm" class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="password" placeholder="Confirm Password" name="cpassword" />
								</div>
        ...
        <script>
            ...
            const registerUrl = "{{ url('admin/registeration') }}";
            const baseUrl = "{{ url('admin/upload') }}";
        </script>
		<script src="{{ asset('assets/js/js/pages/custom/login/login-general.js')}}"></script>
		<!-- <script src="{{ asset('assets/js/js/pages/custom/login/login-general.js')}}"></script> -->
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
